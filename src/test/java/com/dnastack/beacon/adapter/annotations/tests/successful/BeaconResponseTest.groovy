...
import static com.dnastack.beacon.adater.annotations.AnnotationsBeaconAdapter.SAMPLE_BEACON
...
class BeaconResponseTest extends BaseTest {
    ...
    private void checkAssertions(BeaconAlleleResponse response, BeaconAlleleRequest request) {
        ...
        assertThat(response.beaconId).isEqualTo(SAMPLE_BEACON.id)
        ...
        assertThat(datasetResponse.datasetId).isEqualTo(TEST_VARIANT_ANNOTATION_SET.id)
