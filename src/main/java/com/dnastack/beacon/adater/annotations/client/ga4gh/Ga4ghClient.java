...
public class Ga4ghClient {
    ...
    public VariantAnnotationSet loadVariantAnnotationSet(String id) throws Ga4ghClientException {
        return executeCall(ga4ghRetroService.loadVariantAnnotationSet(id));
    }

    public VariantSet loadVariantSet(String id) throws Ga4ghClientException {
        return executeCall(ga4ghRetroService.loadVariantSet(id));
    }
    ...
    public Variants.CallSet loadCallSet(String id) throws Ga4ghClientException {
    ...
    private <REQUEST extends GeneratedMessage, RESPONSE> RESPONSE loadResponsePage(Message.Builder requestBuilder,
